"""
Integration Tests for FlashTile
===============================

End-to-end tests verifying training convergence and real-world usage patterns.

These tests ensure that Flash Attention implementations work correctly in
actual training scenarios, not just isolated forward/backward passes.
...
class TestTrainingConvergence:
    ...
    def _create_synthetic_task(self, config, device):
        ...
        # Create dataset: random input, target is the same input (identity task)
