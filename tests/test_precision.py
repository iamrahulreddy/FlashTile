"""
Precision and Mixed-Precision Tests
====================================

This module tests numerical precision and mixed-precision training
scenarios for FlashTile's attention implementations.

Tests verify:
1. BF16 and FP16 attention correctness
2. FP32 accumulator usage in softmax
3. Numerical stability under edge cases
4. Gradient precision in backward pass
5. FP8 compatibility (when available)

Requirements
------------
- PyTorch >= 2.0.0 (for BF16 support)
- CUDA GPU with BF16 support (Ampere+)

Usage
-----
```bash
pytest tests/test_precision.py -v
pytest tests/test_precision.py -v -k "bf16"
```
"""
