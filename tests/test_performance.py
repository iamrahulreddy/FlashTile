"""
Performance Benchmark Tests for FlashTile.

These tests verify performance characteristics:
- Flash uses less memory at long sequences
- Memory scales linearly (not quadratically)
...
def benchmark_forward(
    ...
    Returns:
        Dictionary with 'time_ms' and 'memory_mb' keys
    """
    device = x.device
...
class TestPerformanceScaling:
    ...
    def test_flash_timing_characteristics(self, seq_len, device):
        ...
        # Our Python-loop implementation is inherently slower than PyTorch's fused
