...
Tests verifying correctness of SlidingWindowAttention implementation.
...
class TestSlidingWindowCorrectness:
    ...
    def test_window_boundary_conditions(self, device):
        ...
        # Modify a position outside the window of position 0
        # For position 0 with window_size=8, it can see positions [0] (causal)
        # Position 10 is definitely outside the window
        x_modified = x.clone()
