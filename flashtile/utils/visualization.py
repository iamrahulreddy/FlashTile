...
class ColorPalette:
    ...
    # Primary palette - modern, accessible
    PRIMARY = {
        "naive": "#E74C3C",      # Coral red - naive baseline
        "flash_v1": "#3498DB",   # Blue - V1
        "flash_v2": "#2ECC71",   # Green - V2
        "triton": "#9B59B6",     # Purple - Triton kernel
        "gqa": "#F39C12",        # Orange - GQA
        "mqa": "#1ABC9C",        # Teal - MQA
        "pytorch": "#34495E",    # Dark gray - PyTorch reference
    }
    
    # Gradient palette for sequence lengths
    GRADIENT = [
        "#3498DB",  # Light blue
        "#2980B9",  # Medium blue
        "#1ABC9C",  # Teal
